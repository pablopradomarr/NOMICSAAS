 ...
 * §6.2). Marca CFOnomic: mismos tokens que `organization-invite-email.tsx`. El enlace
...
export const PasswordResetEmail: React.FC<PasswordResetEmailProps> = ({ resetUrl }) => (
  <EmailLayout preview="Restablece tu contraseña de CFOnomic">
    <h2 style={{ color: "#1A202C", fontSize: "20px" }}>Restablece tu contraseña</h2>
    <p style={{ fontSize: "15px", color: "#1A202C" }}>
      Hemos recibido una solicitud para restablecer la contraseña de tu cuenta de <strong>CFOnomic</strong>. Si
      no has sido tú, puedes ignorar este mensaje: tu contraseña actual sigue siendo válida.
    </p>
