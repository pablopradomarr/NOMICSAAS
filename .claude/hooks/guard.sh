...
case "$rel" in
  lib/ledger/*.test.ts|lib/analytics/*.test.ts|lib/accounts/*.test.ts|lib/taxes/*.test.ts|lib/audit/*.test.ts|lib/bank/*.test.ts|lib/closing/*.test.ts|lib/recurring/*.test.ts|lib/budget/*.test.ts|lib/time/*.test.ts) ;;
  lib/ledger/*|lib/analytics/*|lib/accounts/*|lib/taxes/*|lib/audit/*|lib/bank/*|lib/closing/*|lib/recurring/*|lib/budget/*|lib/time/*)
