...
| ID | Invariante | Tol. |
|---|---|---|
| **I-E12-1** | **Determinismo de extremo a extremo.** Purgados todos los derivados (`purgeDerived`, con el **registro declarado** `DERIVED_MODELS` — ADR-0023 — y sin ninguna tabla de caché sin declarar) y regenerados, las **12 cifras canónicas** y los **cinco sellos** salen idénticos **byte a byte**, en los tres órdenes de regeneración | 0 |
