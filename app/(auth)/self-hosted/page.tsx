    ...
    return (
      <Card className="w-full max-w-xl mx-auto p-8 flex flex-col items-center justify-center gap-6">
        <CardTitle className="text-2xl font-bold flex items-center gap-2">
          ...
          <span>El modo autoalojado no está activado</span>
        </CardTitle>
        <CardDescription className="text-center text-lg flex flex-col gap-2">
          <p>
            Para usar CFOnomic en modo autoalojado, define <code className="font-bold">SELF_HOSTED_MODE=true</code> en
            el entorno.
          </p>
          <p>
            En modo autoalojado usas tu propia clave de API del proveedor de IA y tus datos se quedan en tu servidor.
          </p>
        </CardDescription>
      </Card>
    )
  ...
  return (
    <Card className="w-full max-w-xl mx-auto p-8 flex flex-col items-center justify-center gap-4">
      ...
      <CardTitle className="text-3xl font-bold ">
        <ColoredText>CFOnomic · edición autoalojada</ColoredText>
      </CardTitle>
      <CardDescription className="flex flex-col gap-4 text-center text-lg">
        <p>Bienvenido a tu instancia de CFOnomic. Configura un par de ajustes para empezar.</p>
