...
//
// `docs/design/fixtures/presupuesto-horas-esperado.v1.2.json` es el contrato de
...
const E10_PATH = path.join(process.cwd(), "docs", "design", "fixtures", "presupuesto-horas-esperado.v1.2.json")
