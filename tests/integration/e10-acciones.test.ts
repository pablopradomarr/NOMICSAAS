 ...
 *    cifras de cabecera de `presupuesto-horas-esperado.v1.1.json` —INGRESOS −76 400,
...
const expected = JSON.parse(
  readFileSync(path.join(process.cwd(), "docs", "design", "fixtures", "presupuesto-horas-esperado.v1.1.json"), "utf8")
) as {
