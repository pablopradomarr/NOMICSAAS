 ...
 *    cifras de cabecera de `presupuesto-horas-esperado.json` —INGRESOS −76 400,
...
const expected = JSON.parse(
  readFileSync(path.join(process.cwd(), "docs", "design", "fixtures", "presupuesto-horas-esperado.json"), "utf8")
) as {
