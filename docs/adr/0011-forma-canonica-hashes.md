...
**Estado:** APROBADO por Pablo el 2026-09-05 (permiso general delegado) · **NOTA DE ALCANCE añadida el 2026-09-21** (E12 · T11/T23, permiso delegado de 2026-09-21): ver «Nota de alcance» al final —no cambia ninguna tupla— · **Nivel:** 2 · **Fecha:** 2026-09-05 · **Épica:** E4 · **Sustituye:** la tabla de tuplas de `docs/adr/0010-reclasificacion-analitica.md` §«Decisión E4-D2 — Tres sellos, tres oficios» · **Implementación:** `lib/ledger/hash.ts`, `lib/analytics/hash.ts`, `models/ledger.computeLedgerHash`, migración `20260908100000_e4_analytics` §7f
...
### Nota de alcance (E12 · T11/T23) — qué sello es reproducible entre COPIAS

> **Añadida el 2026-09-21.** **APROBADA por Pablo** (permiso delegado de
> 2026-09-21). **No modifica ninguna tupla de este ADR**: lo que hace es escribir
> una consecuencia que estaba implícita y que la ola B de E12 pagó al enfrentar
> una restauración contra su origen.

Este ADR razona la comparabilidad **entre organizaciones y entre cargas del mismo
