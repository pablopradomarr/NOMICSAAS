...
### Alcance entre COPIAS

Qué sello sobrevive a una **restauración** —y por qué los dos `analyticsKey` son
dos oficios distintos y no una duplicación— lo escribe
`docs/adr/0021-alcance-de-los-sellos-entre-copias.md`, que **complementa** a éste
y no cambia ninguna tupla.
